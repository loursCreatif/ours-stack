...
| Stage | `quick` | `standard` | `literature-review` |
|-------|---------|------------|---------------------|
| **1. Discover** (search hits logged) | 30–50 | 80–120 | **150–250+** |
| **2. Screen** (title + abstract relevance) | 8–12 | 25–40 | **50–80** |
| **3. Eligible** (on-topic, accessible, tier OK) | 5–8 | 15–25 | **25–40** |
| **4. Read in depth** | 2–3 | 8–12 | **15–25** |
| **5. Cited in synthesis** | 3–5 | 10–15 | **20–35** |

**Default mode:** `literature-review` when user says "deep research", "recherche approfondie", or `/deep-research` without a time constraint.
